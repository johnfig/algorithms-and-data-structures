...
class Node
  attr_accessor :node, :previous, :next
...
puts "Next before node 4 is: #{node_4.previous.node}"
puts "Next before node 3 is: #{node_3.previous.node}"
puts "Next before node 2 is: #{node_2.previous.node}"
